...
impl Header {
    fn new<R: Read>(mut reader: R, size: u64) -> IoResult<Header> {
        ...
        // Keep the field prime from the R1CS header instead of rejecting
        // anything that is not bn254/bn256. This matches newer upstream work
        // and lets us test whether the rest of the parser can handle the
        // BLS12-381 artifacts used by this circuit.
