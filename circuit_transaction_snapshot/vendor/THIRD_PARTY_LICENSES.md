...
- The MIT-licensed files (blake2) require that the copyright notice and the
  permission notice above be preserved in distribution; that is the purpose of
  this file and the accompanying `LICENSE-*` texts.
