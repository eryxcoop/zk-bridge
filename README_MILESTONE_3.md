...
There are Aiken tests for the unlocking script and the used transactions set in [this file](bridge-aiken/validators/tests/unlocking_validator_test.ak) and [this file](bridge-aiken/validators/tests/txs_updater_validator_test.ak) respectively. Their names are mostly self-explanatory.
